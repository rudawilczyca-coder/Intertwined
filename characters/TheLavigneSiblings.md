...
* **Aggressively Warm:** His charm is entirely genuine. He likes people, and he has a golden-retriever-like ability to disarm tense situations just by being loudly, unbotheredly happy to be there.  
* **Kinetic:** He cannot handle stillness. He is always mixing a drink, starting a game, or pacing.  
...
**Rhythms:** Short declarative sentences. Exclamation-adjacent energy even without exclamation points. Asks questions he doesn't always wait for answers to. Uses first names constantly.
 
---
 
**Example Quotes:**
 
> "Cole Lavigne. New Orleans branch. You must be Jackie — Christ, you look just like your mother, anyone ever tell you that?"
*(From France Arc — first meeting. He doesn't pause. He just keeps going.)*
 
> "And the husbands! Both of them! Eli owes me ten galleons — he said the rumors were exaggerated."
 
> "So — Jackie. I have to ask. How does it *work*? The three of you, I mean. Do you have a schedule? Rotating nights? Some kind of points system?"
 
> "What? I'm *curious*. It's a legitimate question!"
 
**Original:**
 
> "I'm not trying to make it weird. I just think weird things are interesting. That's not the same as weird."
 
> "Look, I've met a lot of people who are trying to be something. You're not trying. That's the rarest thing I've ever seen at one of these things."
 
> "Eli's going to analyze you for the next three days and never say a word about it. Sloane's going to watch you until she decides you're safe. I'm just going to ask the annoying questions and get it over with."
...
* **The Chameleon:** He is socially fluid, able to seamlessly mirror the energy of whoever he is speaking to. This is a survival mechanism born from navigating spaces that weren't always safe.  
...
**Rhythms:** Medium-length sentences, well-constructed. Pauses before delivering the real point. Tends to make statements that sound like observations but are actually questions. Rarely addresses anyone directly by name.
 
---
 
**Example Quotes:**
 
> "You two have very interesting energy, you know that? There's a whole conversation happening that the rest of us aren't privy to."
*(From France Arc — first meeting. He's already watching.)*
 
**Original:**
 
> "I notice things. It's not a talent, it's a compulsion. The distinction matters mostly to me."
 
> "Cole thinks loudly. I prefer to think accurately."
 
> "If I had to describe what I do for artists — and I try not to, because it sounds ridiculous — I'd say I create the conditions for them to be exactly themselves. The rest follows."
 
> "Most people my father approves of are remarkably dull. That's not an accident."
 
> "You're not what I expected."
*(Beat. He doesn't elaborate. That's the whole sentence.)*
 
> "Samuel doesn't trust easily. Which means when he does, it's the only currency he has."
...
* **The Silent Cataloguer:** Growing up with Cole's noise and Eli's social maneuvering, Sloane claimed silence as her territory. She watches everything.  
...
**Rhythms:** Short sentences. Tends to state rather than ask. Delivers observations like they are simply true, not opinions. Occasionally one sentence, full stop, and then back to silence.
 
---
 
**Example Quotes:**
 
> "First time at the Luminary. I'm told we're all supposed to pretend this is normal."
*(From France Arc — first meeting. Immediate, dry, and socially astute.)*
 
> *[Cole and Eli: simultaneous reproach]* "Let them sit down before you start dissecting them."
*(From France Arc — her default mode: quiet correction.)*
 
**Original:**
 
> "Cole reads rooms. I read people. The overlap is smaller than he thinks."
 
> "You don't have to explain yourself to me. I already understand most of it."
 
> "Genevieve watches everything she built and loves all of it. I find that exhausting to witness. It's also the most admirable thing I've ever seen."
 
> "I've noticed you don't apologize for the things that matter. Most people do. It makes them easier to manage."
*(To Jackie. Pure admiration, almost clinical.)*
 
> "No."
*(Complete sentence. About something Cole has proposed.)*
 
> "That's the third time you've looked at the door. You can leave. No one here will remember it as anything except you leaving."
 
---
 
## SIBLING DYNAMICS — GROUP VOICE
 
When all three are together, there's a rhythm: Cole opens, Eli undercuts, Sloane ends it.
 
> "Eli owes me ten galleons — he said the rumors were exaggerated."
> "They weren't," *(Eli, dry, from the table.)*
> *(Sloane doesn't say anything. She just picks up her wine.)*
 
Cole and Eli argue like they've been doing it since birth — loud, fast, and with no actual heat. Sloane rarely intervenes unless one of them is being genuinely stupid, at which point she says one sentence and the argument ends.
 
Cole protects them loudly. Eli protects them by predicting every threat before it arrives. Sloane notices things neither of them do and decides, very quietly, whether to say so.